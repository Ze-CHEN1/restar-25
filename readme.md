# 同济大学 SuperPower 战队 RoboMaster 25 赛季视觉代码

本仓库是同济大学 SuperPower 战队 RoboMaster 25 赛季的视觉代码，包含相机与通信、装甲板和能量机关识别、位姿解算、目标跟踪、预测、轨迹规划、火控、标定和离线测试。

仓库同时内置了一套面向 RoboMaster 视觉开发的研究 Agent，用于将算法研究整理为可复现、可恢复、可验证的工程流程。
